  ...
  return (
    <div>
      ...
      <div className={styles.contactItem}>
        ...
        <div className={styles.details}>Bakı, Süleyman Rüstəm 15e</div>
      </div>
      <div className={styles.contactItem}>
        <div className={styles.contactIcon}>
          <MdLocalPhone size={44} />
        </div>
        <div className={styles.details}>
          <div>+994 77 244 71 00</div>
          <div>+994 12 493 64 04</div>
        </div>
      </div>
      <div className={styles.contactItem}>
        <div className={styles.contactIcon}>
        ...
        <div className={styles.details}>office@mstore.az</div>
      </div>
    </div>
      </div>
      <Advantages />
